// Shared variable for hand presence
let HAND_PRESENT = false;

// Function called by MediaPipeHands.js
function setHandPresent(v) {
  HAND_PRESENT = !!v;
  console.log("Hand detected:", HAND_PRESENT);

  // Example: react to detection
  if (HAND_PRESENT) {
    // later, we’ll trigger your scene change or animation here
  }
}
